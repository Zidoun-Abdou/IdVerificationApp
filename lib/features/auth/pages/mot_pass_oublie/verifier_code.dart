...
import 'package:whowiyati/features/auth/pages/mot_pass_oublie/reset_password.dart';
import 'package:whowiyati/core/widgets/custom_main_button.dart';
import 'package:whowiyati/core/widgets/custom_pin_field_auto_fill.dart';
  ...
  sendCodeEmail() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('mail not sent');
        SnackBarMessage().showErrorSnackBar(
            message: "E-mail non envoyé, réessayez", context: context);
        print(response.reasonPhrase);
      }
    } on Exception {
      SnackBarMessage().showErrorSnackBar(
