...
import 'package:whowiyati/core/widgets/custom_question_show_bottom_sheet.dart';
import '../../../const.dart';
    ...
    try {
      ...
      if (response.statusCode == 200 && answerJson["valid"] == true) {
        Alert(
          context: context,
          title: "Succès",
          desc: "Ce document est vérifié avec succès",
        ...
        Alert(
          context: context,
          title: "Échoué",
          desc: "Ce document n'est pas vérifié",
