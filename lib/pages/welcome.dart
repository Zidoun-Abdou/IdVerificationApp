                                                                      ...
                                                                      children: [
                                                                        ElevatedButton(
                                                                          onPressed:
                                                                            ...
                                                                            await prefs.remove("name_latin");
                                                                            await prefs.remove("surname_latin");
                                                                            await prefs.remove("birth_date");
                                                                            await prefs.remove("deliv_date");
                                                                            await prefs.remove("exp_date");
                                                                            await prefs.remove("document_number");
                                                                            await prefs.remove("user_id");
                                                                            await prefs.remove("phone");
                                                                            await prefs.remove("mail");
                                                                            await prefs.remove("nin");
                                                                            await prefs.remove("pasword");
                                                                  ...
                                                                  Navigator.of(
                                                                    ...
                                                                    PageRouteBuilder(
                                                                      ...
                                                                      transitionsBuilder: (context,
                                                                          ...
                                                                          child) {
                                                                        var tween =
                                                                            Tween<Offset>(begin: const Offset(0.0, 1.0), end: Offset.zero).chain(CurveTween(curve: Curves.easeInOut));
